/* Minimal underscore shim used by the Node build and by the test suite.
 *
 * The browser bundle ships a real (minified) underscore; under Node we only
 * need the handful of helpers the graph algorithms actually call, so this
 * module re-exports them from the `underscore` package plus a few hand-written
 * fast paths. `node-pre.js` requires this file, which means the Node bundle and
 * the tests share one definition of `_` instead of two drifting copies.
 */
